...
relm.define_element({
	name = "CombinatorGui.Mode.InventoryControl",
	render = function(props) return nil end,
})

relm.define_element({
	name = "CombinatorGui.Mode.InventoryControl.Help",
	render = function(props)
		return VF({
			ultros.RtMultilineLabel({
				"cybersyn2-combinator-mode-inventory-control.desc",
			}),
			Pr({
				type = "label",
...
cs2.register_combinator_mode({
	...
	localized_string = "cybersyn2-combinator-modes.inventory-control",
	settings_element = "CombinatorGui.Mode.InventoryControl",
	help_element = "CombinatorGui.Mode.InventoryControl.Help",
	is_input = true,
})
